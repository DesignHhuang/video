...
public class VideoStreamProcessor {
	...
	public static void main(String[] args) throws Exception {
		...
		prop.put("bootstrap.servers", "192.168.2.76:9092");
		...
		map.put("metadata.broker.list", "192.168.2.76:9092");
